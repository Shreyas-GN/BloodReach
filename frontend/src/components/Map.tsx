...
const Map: React.FC<MapProps> = ({
  ...
  return (
    <div className={`p-1.5 rounded-[2rem] bg-white/5 dark:bg-black/10 backdrop-blur-md shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-slate-200 dark:border-white/10 ${className}`}>
      <div 
        ref={mapContainer} 
        className="w-full h-full rounded-[calc(2rem-0.375rem)] overflow-hidden bg-slate-100 dark:bg-zinc-950 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)]"
      />
    </div>
  );
};
